...
export const metadata: Metadata = {
  title: "Energy - Tesla",
  description:
    "Power your home with Tesla's solar energy solutions - Solar Roof, Powerwall, and solar panels.",
};
      ...
      <main className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-xl text-midlife-light-gray mb-12 font-satoshi max-w-3xl">
            Power your home and business with clean energy solutions from solar
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-gray-800 to-midlife-dark-gray rounded-3xl p-12">
              <h3 className="text-3xl font-bold text-midlife-text mb-4 font-termina">
                Solar Roof
              </h3>
              <p className="text-midlife-light-gray mb-6 font-satoshi">
                Power your home with a beautiful solar roof that generates clean
                energy.
              </p>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-midlife-dark-gray rounded-3xl p-12">
              ...
              <p className="text-midlife-light-gray mb-6 font-satoshi">
                Store energy for when you need it most with our home battery
                system.
              </p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-3">
          ...
          <div className="mt-20 bg-gradient-to-r from-green-900/20 to-blue-900/20 rounded-3xl p-12 lg:p-20 border border-green-500/20">
            <h3 className="text-4xl font-bold text-midlife-text mb-8 font-termina">
              Global Impact
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold text-green-500 mb-2 font-termina">
                  10M+
                </div>
                <div className="text-midlife-light-gray font-satoshi">
                  Tons of CO2 Saved
                </div>
              </div>
              <div className="text-center">
